...
import { Dices, Eye, Square, SmilePlus, Radio, Antenna, Layers, Palette, Check, X, Loader2 } from "lucide-react";

// ─── Bottts option sets ────────────────────────────────────────────────────────
const EYES_OPTIONS = ["bulging", "dizzy", "eva", "frame1", "frame2", "glow", "happy", "hearts", "robocop", "round", "roundFrame01", "roundFrame02", "sensor", "shade01"] as const;
const FACE_OPTIONS = ["round01", "round02", "square01", "square02", "square03", "square04"] as const;
const MOUTH_OPTIONS = ["bite", "diagram", "grill01", "grill02", "grill03", "smile01", "smile02", "square01", "square02"] as const;
const SIDES_OPTIONS = ["antenna01", "antenna02", "cables01", "cables02", "round", "square", "squareAssymetric"] as const;
const TOP_OPTIONS = ["antenna", "antennaCrooked", "bulb01", "glowingBulb01", "glowingBulb02", "horns", "lights", "pyramid", "radar"] as const;
const TEXTURE_OPTIONS = ["camo01", "camo02", "circuits", "dirty01", "dirty02", "dots", "grunge01", "grunge02"] as const;
const BASE_COLORS = ["00acc1", "1e88e5", "5e35b1", "7cb342", "8e24aa", "039be5", "43a047", "00897b", "3949ab", "d81b60", "e53935", "f4511e", "fb8c00", "ffb300"] as const;
...
export default function OnboardingPage() {
  ...
  useEffect(() => {
    ...
    if (!usernameRegex.test(username)) { setUsernameStatus("idle"); return; }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="w-full">
              <p className="text-xs text-zinc-500 text-center mb-2 uppercase tracking-widest">Customize your bot</p>
          ...
          <div>
            ...
            {username && !/^[a-zA-Z0-9_]{3,20}$/.test(username) && (
              <p className="text-sm text-zinc-400 mt-1">Must be 3-20 characters, alphanumeric and underscore only</p>
            )}
          </div>
