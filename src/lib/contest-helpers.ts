 ...
 *
 * Import path: @/lib/contest-helpers
 */
 ...
 * Falls back to Math.random() if crypto is unavailable (non-Node environments).
 */
 ...
 * Must be called within a Prisma transaction or standalone.
 */
