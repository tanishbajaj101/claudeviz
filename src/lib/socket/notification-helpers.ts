 ...
 *
 * Centralises all real-time notification delivery so API routes and
 ...
 *
 * Import path: @/lib/socket/notification-helpers
 */

import { prisma } from "@/lib/prisma";
import { getNotificationsNamespace } from "./server";
