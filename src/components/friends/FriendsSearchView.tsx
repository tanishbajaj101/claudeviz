        ...
        <div className="flex h-full flex-col">
            ...
            <div className="flex items-center gap-2 px-3 py-3 border-b border-zinc-800">
                ...
                <input
                    ...
                    className="flex-1 bg-zinc-800/60 border border-zinc-700 rounded-md px-3 py-1.5 text-sm text-zinc-100 placeholder-zinc-500 outline-none focus:border-emerald-500/60 transition-colors"
                />
            </div>
                    ...
                    <div className="flex flex-col gap-0.5">
                        {results.map((user) => (
                            <button
                                ...
                                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left opacity-60 hover:opacity-80 transition-opacity hover:bg-zinc-800/40"
                            >
                                {/* Avatar */}
                                {user.avatar_svg ? (
                                    <div
                                    ...
                                    <div className="h-9 w-9 rounded-full bg-zinc-700 flex items-center justify-center text-sm font-bold text-zinc-300 shrink-0">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    {user.is_friend && (
                                        <p className="text-xs text-zinc-500">Already friends</p>
                                    )}
                                </div>
                            </button>
                        ))}
