    ...
    <div className="flex h-screen items-center justify-center bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950">
      <div className="w-full max-w-md space-y-8 rounded-lg border border-border bg-card/50 p-8 backdrop-blur-sm">
        ...
        {error && (
          <div className="rounded-md bg-red-500/10 border border-red-500/20 p-4">
            <p className="text-sm text-red-400">
              ...
              {error === 'no_user' && 'Failed to create user account.'}
              {error === 'server_error' && 'Server error. Please try again later.'}
              {!['oauth_failed', 'no_user', 'server_error'].includes(error) &&
        ...
        <div className="space-y-4">
          <button
            onClick={signIn}
            className="w-full flex items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 text-sm font-medium text-zinc-900 transition-colors hover:bg-zinc-100"
          >
